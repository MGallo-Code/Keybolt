...
pub enum Message {
    ...
    UpdateCardMiddleInitial(String),
    UpdateCardLastName(String),
    UpdateCardNumber(String),
    UpdateCardExpirationMonth(String),
    UpdateCardExpirationYear(String),
    UpdateCardSecurityCode(String),
    UpdateCardAddress(String),
    UpdateCardCity(String),
    UpdateCardCountry(String),
    UpdateCardState(String),
    UpdateCardZipcode(String),
    UpdateCardAptNumber(String),
}